...
data.NamesList[3] = [
	...
	[['Электрозаводская, АПЛ', 1944, 2007], ['Электрозаводская, АПЛ', 2008]],
...
data.NamesList[8] = [
	...
	[['Деловой центр, КСЛ', 2014, 2018], ['Деловой центр, КСЛ', 2020]],
	[['', 2018, 2020]],
	[['Шелепиха, КСЛ', 2018, 2020]],
	[['Хорошёвская, КСЛ', 2018, 2020]],
	[['ЦСКА, КСЛ', 2018, 2020]],
	[['Петровский парк, КСЛ', 2018, 2020]],
	[['Савеловская, КСЛ', 2018, 2020]]
];
...
data.NamesList[11] = [
	[['Каховская', 1969, 2019], ['Каховская', 2022]],
	[['Варшавская', 1969, 2019], ['Варшавская', 2022]],
	[['Каширская, КХЛ', 1969, 2019], ['Каширская, КХЛ', 2022]]
];
...
// Большая кольцевая линия вместе с Солнцевской:
...
data.NamesList[15] = [
	[['Шелепиха, БКЛ ', 2018, 2020]],
	[['Хорошёвская, БКЛ ', 2018, 2020]],
	[['ЦСКА, БКЛ ', 2018, 2020]],
	[['Петровский парк, БКЛ ', 2018, 2020]],
	[['Савеловская, БКЛ ', 2018, 2020]]
];
...
data.NamesList[16] = [
	...
	[['', 2018, 2020], ['Шелепиха, БКЛ', 2020]],
	[['Хорошёвская, БКЛ', 2018, 2018], ['Хорошёвская, БКЛ', 2020]],
	[['ЦСКА, БКЛ', 2018, 2018], ['ЦСКА, БКЛ', 2020]],
	[['Петровский парк, БКЛ', 2018, 2018], ['Петровский парк, БКЛ', 2020]],
	[['Савеловская, БКЛ', 2018, 2018], ['Савеловская, БКЛ', 2020]]
];
...
data.CoordinatesList[17] = [
	[55.780312, 37.702998, -20, 131],
	[55.764776, 37.706725, -26, 142],
	[55.753714, 37.719108, -15, 152],
	[55.731920, 37.729441, -22, 139],
	[55.727013, 37.753158, -19, 145],
	[55.718342, 37.781728, -21, 149],
	[55.704966, 37.819033, -20, 134],
...
data.NamesList[17] = [
	[['Электрозаводская, НЛ', 2020]],
	[['Лефортово', 2020]],
	[['Авиамоторная, НЛ', 2020]],
	[['Нижегородская, НЛ', 2020]],
	[['Стахановская', 2020]],
	[['Окская', 2020]],
	[['Юго-Восточная', 2020]],
	[['Косино', 2019]],
...
data.Interchanges = [
	...
	['Авиамоторная, КЛЛ', 'Авиамоторная, НЛ'],
	['Электрозаводская, АПЛ', 'Электрозаводская, НЛ'],
	// На Монорельсе:
	...
	['Шелепиха, МЦК', 'Шелепиха, БКЛ '],
	['Шелепиха, МЦК', 'Шелепиха, БКЛ'],
	['Окружная, МЦК', 'Окружная, ЛДЛ'],
	['Нижегородская, МЦК', 'Нижегородская, НЛ'],
	// На Большой кольцевой линии:
	['Савеловская, БКЛ ', 'Савеловская, КСЛ'],
	['Савеловская, БКЛ ', 'Савеловская, СТЛ'],
	['Савеловская, БКЛ', 'Савеловская, СТЛ'],
	['Петровский парк, БКЛ ', 'Динамо'],
	['Петровский парк, БКЛ', 'Динамо'],
	['Петровский парк, БКЛ ', 'Петровский парк, КСЛ'],
	['ЦСКА, БКЛ ', 'ЦСКА, КСЛ'],
	['Хорошёвская, БКЛ ', 'Хорошёвская, КСЛ'],
	['Хорошёвская, БКЛ ', 'Полежаевская'],
	['Хорошёвская, БКЛ', 'Полежаевская'],
	['Хорошёвская, БКЛ ', 'Хорошёво'],
	['Хорошёвская, БКЛ', 'Хорошёво'],
